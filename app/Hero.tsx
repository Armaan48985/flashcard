...
const Hero = () => {
    ...
    return (
      <div className="w-full min-h-screen bg-black flex flex-col text-white">
        <div className="w-full flex-between p-6 mt-8">

            <div>
                <ConnectButton showBalance={false} chainStatus='none'/>
            </div>

          <h1 className="text-6xl font-bold text-white text-center relative">
            FlashCards
            <span className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-56 h-1 bg-blue-500 rounded-full"></span>
          </h1>
  
          <button
            className="flex justify-end bg-[#163664] px-4 my-6 py-2 cursor-pointer rounded-xl"
        ...
        <div className="w-full flex-center gap-[15rem] mt-12">
          {cardData.length > 0 ? (
            <>
              <div>
                <span
